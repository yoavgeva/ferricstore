...
pub struct DynNifCallbacks {
    ...
    enif_init_resource_type: Option<extern "C" fn (env: *mut ErlNifEnv, name_str: *const c_char, init: *const ErlNifResourceTypeInit, flags: ErlNifResourceFlags, tried: *mut ErlNifResourceFlags) -> *const ErlNifResourceType>,
    enif_dynamic_resource_call: Option<extern "C" fn (env: *mut ErlNifEnv, module: ERL_NIF_TERM, name: ERL_NIF_TERM, rsrc: ERL_NIF_TERM, call_data: *const c_void) -> c_int>,
}
...
#[inline]
pub unsafe extern "C" fn enif_init_resource_type(env: *mut ErlNifEnv, name_str: *const c_char, init: *const ErlNifResourceTypeInit, flags: ErlNifResourceFlags, tried: *mut ErlNifResourceFlags)
 -> *const ErlNifResourceType{
    (DYN_NIF_CALLBACKS.enif_init_resource_type.unwrap_unchecked())(env, name_str, init, flags, tried)
}

/// See [enif_dynamic_resource_call](http://www.erlang.org/doc/man/erl_nif.html#enif_dynamic_resource_call) in the Erlang docs.
#[inline]
pub unsafe extern "C" fn enif_dynamic_resource_call(env: *mut ErlNifEnv, module: ERL_NIF_TERM, name: ERL_NIF_TERM, rsrc: ERL_NIF_TERM, call_data: *const c_void)
 -> c_int{
    (DYN_NIF_CALLBACKS.enif_dynamic_resource_call.unwrap_unchecked())(env, module, name, rsrc, call_data)
}
