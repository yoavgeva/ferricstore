defmodule Ferricstore.Store.ShardTest do
  ...
  describe "ETS hot cache" do
    ...
    test "delete evicts ETS entry", %{shard: shard, index: index} do
      ...
      ets = :ets.whereis(:"shard_ets_#{index}")
      assert [] == :ets.lookup(ets, "evict_key")
    end
